...
RUN dotnet build "LineItem.Api.csproj" --configuration $BUILD_CONFIGURATION --no-restore
...
ARG BUILD_CONFIGURATION
RUN dotnet publish "LineItem.Api.csproj" --configuration $BUILD_CONFIGURATION --output /app/publish --no-build
